...
void loop()
{
  ...
  if ( middleIRSensorValue == LOW)
  {
    rotateMotor(-MOTOR_SPEED, MOTOR_SPEED);
  }
  //If right sensor detects black line, then turn right
  else if (rightIRSensorValue == HIGH && leftIRSensorValue == LOW && middleIRSensorValue == HIGH )
  {
    rotateMotor(-MOTOR_SPEED,0);
  }
  //If left sensor detects black line, then turn left  
  else if (rightIRSensorValue == LOW && leftIRSensorValue == HIGH && middleIRSensorValue == HIGH )
  {
